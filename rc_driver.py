...
class VideoStreamHandler(SocketServer.StreamRequestHandler):
    ...
    cup_cascade = cv2.CascadeClassifier('cascade_xml/cup.xml')
        ...
        try:
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    v_param3 = self.obj_detection.detect(self.cup_cascade, gray, image)
...
class ThreadServer(object):
    ...
    distance_thread = threading.Thread(target=server_thread2, args=('165.132.138.161', 9998))
